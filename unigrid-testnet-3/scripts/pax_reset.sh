...
# to run this script
# wget -4qO- -o- raw.githubusercontent.com/unigrid-project/unigrid-cosmos-networks/master/unigrid-testnet-3/scripts/pax_reset.sh | bash
...
GENESIS_URL="https://raw.githubusercontent.com/unigrid-project/unigrid-cosmos-networks/master/unigrid-testnet-3/genesis/genesis.json"
wget -O genesis.json $GENESIS_URL

CHECKSUM_URL="https://raw.githubusercontent.com/unigrid-project/unigrid-cosmos-networks/master/unigrid-testnet-3/genesis/sha256sum.txt"
...
[Service]
User=$USER
ExecStart=/usr/local/bin/paxd start --hedgehog=https://149.102.147.45:39886 --p2p.seeds \"06ed85d8b34ca3a4275072894fc297dce416b708@194.233.95.48:26656,e339ab8163a2774fccbc78ff09ffbf0991adc310@38.242.156.2:26656\"
Restart=always
RestartSec=3
