...
Remove existing data and log files from `~/.unigrid-testnet-2/data` directory.
...
[Service]
User=<username>
ExecStart=/usr/local/bin/paxd start --home=/home/<username>/.unigrid-testnet-2 --hedgehog=https://149.102.147.45:39886 --p2p.seeds "06ed85d8b34ca3a4275072894fc297dce416b708@194.233.95.48:26656,e339ab8163a2774fccbc78ff09ffbf0991adc310@38.242.156.2:26656"
Restart=always
Restart=always
RestartSec=3
StandardOutput=file:/home/<username>/.unigrid-testnet-2/paxd.log
StandardError=file:/home/<username>/.unigrid-testnet-2/paxd-error.log
...
```bash
# Create new keypair
paxd keys add <key-name> --home=/home/$USER/.unigrid-testnet-2

# Restore existing wallet with mnemonic seed phrase.
paxd keys add <key-name> --recover --home=/home/$USER/.unigrid-testnet-2

# Query the keystore for your public address
paxd keys show <key-name> -a --home=/home/$USER/.unigrid-testnet-2

# Show all keys
paxd keys list --home=/home/$USER/.unigrid-testnet-2
```
...
```bash
tail -f /home/<username>/.unigrid-testnet-2/paxd.log
```
